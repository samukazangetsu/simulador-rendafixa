(
  function () {
    const validateForm = () => {
      ...
      if (souldSubmit) { simulator.simulation.elements.simulateButton.removeAttribute('disabled'); } else { simulator.simulation.elements.simulateButton.setAttribute('disabled', ''); }
    };
